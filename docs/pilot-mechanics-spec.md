...
- Пороги мани `MANA_LEVEL_COSTS` для переходів **LL5→LL6** і **LL10→LL11** — `null`.
- **LL9→LL10 = 2500** суперечить правилу Тіру 2 «крок росте на 200»: 1400 → 1600 → 1800
  дає 2000, а не 2500. LL9 лежить у Тірі 2, тож або в правила є виняток, або число інше.
