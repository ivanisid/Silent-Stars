...
- **Пороги мани виводяться формулою, а не задані списком** (`manaLevelCost` у `logic.js`).
  ...
  між тірами вже дорожчає за новим тіром. Кроки: Тір 1 — 100, Тір 2 — 200, Тір 3 — 300.

  | Перехід | Ціна | Накопичено від LL2 |
  |---|---|---|
  | LL2→LL3 | 1000 | 1000 |
  | LL3→LL4 | 1100 | 2100 |
  | LL4→LL5 | 1200 | 3300 |
  ...
  | LL7→LL8 | 1800 | 8100 |
  | LL8→LL9 | 2000 | 10 100 |
  | LL9→LL10 | 2200 | 12 300 |
  | LL10→LL11 | 2500 | 14 800 |
  | LL11→LL12 | 2800 | 17 600 |

  Вихідний текст правил перелічував 1400, 1600, 1800 і 2500 — усі ці числа формула
  відтворює, але на рівень вище за підписами в тексті, і саме тому там бракувало двох
  переходів: підписи зсунулися на один рівень.
