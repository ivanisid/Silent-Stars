...
- **`Environmental Shielding`** має в таблиці примітку, що він «вже має ціну 100 в
  Інфоцентрі через SALIERI; на загальній полиці буде дубль цін». У каталозі він лежить як
  звичайний резерв рангу 1 за 10 PR — розбіжність цін не вирішена.
