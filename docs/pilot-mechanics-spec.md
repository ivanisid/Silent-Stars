...
- **Каталог резервів** (`client/src/pilot/reserves.js`) перенесений з таблиці «Резерви»:
  **56 позицій** у трьох рангах і чотирьох категоріях (мех, тактичні, для пілота,
  ...
  |---|---|---|---|
  | 1 | 10 PR | 33 | без downtime-дії |
  | 2 | 20 PR | 12 | без downtime-дії |
  | 3 | 40 PR | 11 | правилами не обумовлено |
...
- **Умова купівлі резерву рангу 3 не описана.** Правила кажуть лише, що ранги 1–2
  купуються «без використання downtime дії», а про ранг 3 мовчать. Printer use прив'язаний
  у тексті до списку додаткового ремонту й передруку меха, не до резервів, тоді як
  передмісійні downtime-дії описані саме як пошук резервів. Жодного обмеження в коді не
  закладено, доки це не з'ясовано.
