...
// З ЯКОГО йде підвищення — тому перехід між тірами крокує ще за поточним тіром
// (LL5→LL6 крокує як Тір 1, LL10→LL11 — як Тір 2). Див. manaLevelCost() у logic.js.
//
...
// Додатковий ремонт за PR. Обмежень на покупку в додатку немає: чи потрібна
// downtime-дія — питання правил за столом.
